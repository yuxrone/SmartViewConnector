...
namespace RegOpr
{
	...
	public:
		...
		BOOL	DeleteValue(HKEY rootKey, PTSTR pName);
		BOOL	DeleteKey(HKEY rootKey, PTSTR pName);		//Deletes the subkeys and values of the specified key recursively.
		BOOL    Close(void);
